...
**Worum es geht:** Daten in Tabellen erfassen, berechnen, auswerten und
anschaulich darstellen.

## Warum diese BPE wichtig ist

Tabellenkalkulation ist oft der erste Ort, an dem Daten wirklich systematisch
...
- Eine Auswertung erinnert an einen Algorithmus.
- Ein Diagramm ist eine Form der Ausgabe.
...
- Welche Werte sind Eingaben?
- Welche Formeln verarbeiten diese Werte?
